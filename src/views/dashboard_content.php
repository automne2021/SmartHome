...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (refreshAllBtn) {
        refreshAllBtn.addEventListener('click', function() {
            ...
            // Get fresh data
            Promise.all([
                fetch('index.php?action=getDevices', { headers: { 'X-Requested-With': 'XMLHttpRequest' } }).then(r => r.json()),
                fetch('index.php?action=getSensorData', { headers: { 'X-Requested-With': 'XMLHttpRequest' } }).then(r => r.json())
